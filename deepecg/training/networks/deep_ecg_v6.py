...
from deepecg.training.networks.layers import fc_layer, conv_layer, max_pool_layer, avg_pool_layer, \
                                             batch_norm_layer, dropout_layer, print_output_shape, conv1d


class DeepECGV6(object):
    ...
    def inference(self, input_layer, reuse, is_training, name, print_shape=True):
        ...
        with tf.variable_scope(name, reuse=reuse):
            ...
            with tf.variable_scope(layer_name):
                ...
                # Convolution
                net = conv1d(input_layer, kernel_size=3, strides=1, dilation_rate=1,
                             filters=128, padding='causal', activation=None, use_bias=False,
            ...
            with tf.variable_scope(layer_name):
                ...
                # Convolution
                net = conv1d(net, kernel_size=3, strides=1, dilation_rate=2,
                             filters=128, padding='causal', activation=None, use_bias=False,
            ...
            with tf.variable_scope(layer_name):
                ...
                # Convolution
                net = conv1d(net, kernel_size=3, strides=1, dilation_rate=4,
                             filters=128, padding='causal', activation=None, use_bias=False,
            ...
            with tf.variable_scope(layer_name):
                ...
                # Convolution
                net = conv1d(net, kernel_size=3, strides=1, dilation_rate=8,
                             filters=128, padding='causal', activation=None, use_bias=False,
            ...
            with tf.variable_scope(layer_name):
                ...
                # Convolution
                net = conv1d(net, kernel_size=3, strides=1, dilation_rate=16,
                             filters=128, padding='causal', activation=None, use_bias=False,
            ...
            with tf.variable_scope(layer_name):
                ...
                # Convolution
                net = conv1d(net, kernel_size=3, strides=1, dilation_rate=32,
                             filters=128, padding='causal', activation=None, use_bias=False,
            ...
            with tf.variable_scope(layer_name):
                ...
                # Convolution
                net = conv1d(net, kernel_size=3, strides=1, dilation_rate=64,
                             filters=128, padding='causal', activation=None, use_bias=False,
            ...
            with tf.variable_scope(layer_name):
                ...
                # Convolution
                net = conv1d(net, kernel_size=3, strides=1, dilation_rate=128,
                             filters=128, padding='causal', activation=None, use_bias=False,
            ...
            with tf.variable_scope(layer_name):
                ...
                # Convolution
                net = conv1d(net, kernel_size=3, strides=1, dilation_rate=256,
                             filters=128, padding='causal', activation=None, use_bias=False,
            ...
            with tf.variable_scope(layer_name):
                ...
                # Convolution
                net = conv1d(net, kernel_size=3, strides=1, dilation_rate=512,
                             filters=128, padding='causal', activation=None, use_bias=False,
